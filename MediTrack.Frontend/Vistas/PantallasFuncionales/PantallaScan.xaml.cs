...
public partial class PantallaScan : ContentPage
{
    ...
    {
        InitializeComponent();
        BindingContext = viewModel; // Asigna el ViewModel como el contexto de datos de la página
    }
    ...
    protected override void OnAppearing()
    {
        ...
        {
            vm.IsDetecting = true; // Asegura que la cámara esté activa al mostrar
        }
    }
    ...
    protected override void OnDisappearing()
    {
        ...
        System.Diagnostics.Debug.WriteLine("PantallaScan: OnDisappearing - IsDetecting debería estar en false");
        base.OnDisappearing();
    }
}
...
//        {
//            Formats = ZXing.Net.Maui.BarcodeFormats.OneDimensional, // Para códigos de barras (EAN, UPC, Code 128, etc.)
//            AutoRotate = true,
